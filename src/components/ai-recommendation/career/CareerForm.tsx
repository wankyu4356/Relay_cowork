    ...
    >
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 border border-zinc-200/80 rounded-lg focus:ring-2 focus:ring-iris-500 focus:border-transparent outline-none"
            />
            {showSuggestions && skillInput && filteredSuggestions.length > 0 && (
              <div className="absolute z-10 w-full mt-1 bg-white border border-zinc-200/80 rounded-xl shadow-lg max-h-48 overflow-y-auto">
                {filteredSuggestions.map((suggestion) => (
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-sm text-zinc-600 hover:bg-iris-50 transition-colors"
                  >
                    {suggestion}
                  </button>
                ))}
      ...
      <Card className="p-6 rounded-2xl">
        ...
        <div>
          <input
            ...
            placeholder="0"
            className="w-full px-4 py-2 border border-zinc-200/80 rounded-lg focus:ring-2 focus:ring-iris-500 focus:border-transparent outline-none tnum"
          />
      ...
      <Card className="p-6 rounded-2xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-zinc-400 mt-6 text-lg font-medium">~</span>
          <div className="flex-1">
            <label className="block text-sm font-medium text-zinc-700 mb-1">
              최대 (만원)
            </label>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border border-zinc-200/80 rounded-lg focus:ring-2 focus:ring-iris-500 focus:border-transparent outline-none resize-none"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-1">
