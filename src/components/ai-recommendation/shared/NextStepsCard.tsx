...
import { ScrollStagger } from '../../ui/motion';
...
export function NextStepsCard({
  ...
  return (
    <Card className="p-6 bg-white border-zinc-200/80">
      ...
      <ScrollStagger className="space-y-3 mb-6">
        {steps.map((nextStep, index) => (
          <ScrollStagger.Item key={index} className="flex items-start gap-3 bg-zinc-50 border border-zinc-200/80 p-4 rounded-xl">
