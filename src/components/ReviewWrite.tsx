    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-blue-50">
      ...
      <div className="container-web py-8">
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <Card className="p-8">
              ...
              {rating > 0 && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="text-center text-xl font-semibold text-sky-600"
                >
                  {rating === 5 && '정말 훌륭했어요! ⭐'}
                  {rating === 4 && '만족스러웠어요! 😊'}
                  {rating === 3 && '괜찮았어요 👍'}
          ...
          >
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">상세 리뷰</h3>
              <Textarea
              ...
              <div className="flex justify-between text-sm text-gray-600">
                <span>최소 30자 이상</span>
                <span className={reviewText.length >= 30 ? 'text-sky-600 font-medium' : ''}>
                  {reviewText.length}자
                </span>
              </div>
            </Card>
          ...
          <Card className="p-4 bg-amber-50 border-amber-200">
            <div className="flex gap-2 text-sm text-gray-700">
              ...
              <div>
                <strong>리뷰 공개 안내</strong>
                <p className="mt-1">
                  리뷰는 5개 이상 모이면 일괄 공개됩니다. 
