...
export const CATEGORY_CONTENT: Record<Category, CategoryContent> = {
  transfer: {
    ...
    theme: {
      gradient: 'from-iris-600 to-iris-800',
      bgGradient: 'from-zinc-50 via-white to-iris-50/40',
      accent: 'iris',
      accentLight: 'iris-50',
      accentText: 'text-iris-700',
      cardGradient1: 'from-zinc-900 via-iris-950 to-iris-900',
      cardGradient2: 'from-iris-700 to-iris-900',
      cardGradient3: 'from-iris-800 to-zinc-900',
      buttonClass: 'bg-white text-iris-800 hover:bg-iris-50',
      headerGradient: 'from-zinc-900 to-iris-700',
    },
    sidebarExtras: [
  ...
  admission: {
    ...
    theme: {
      gradient: 'from-iris-500 to-iris-700',
      bgGradient: 'from-zinc-50 via-white to-iris-50/40',
      accent: 'iris',
      accentLight: 'iris-50',
      accentText: 'text-iris-700',
      cardGradient1: 'from-iris-950 via-iris-900 to-zinc-900',
      cardGradient2: 'from-iris-600 to-iris-800',
      cardGradient3: 'from-iris-700 to-iris-900',
      buttonClass: 'bg-white text-iris-800 hover:bg-iris-50',
      headerGradient: 'from-zinc-900 to-iris-700',
    },
    sidebarExtras: [
  ...
  career: {
    ...
    theme: {
      ...
      bgGradient: 'from-zinc-50 via-white to-slate-50/50',
      accent: 'slate',
      accentLight: 'slate-50',
      accentText: 'text-slate-700',
      cardGradient1: 'from-zinc-900 to-slate-800',
      cardGradient2: 'from-slate-600 to-zinc-800',
      cardGradient3: 'from-slate-700 to-zinc-900',
      buttonClass: 'bg-white text-slate-800 hover:bg-slate-50',
      headerGradient: 'from-zinc-900 to-slate-700',
    },
    sidebarExtras: [
  ...
  certification: {
    ...
    theme: {
      ...
      bgGradient: 'from-zinc-50 via-white to-amber-50/50',
      accent: 'amber',
      accentLight: 'amber-50',
      accentText: 'text-amber-700',
      cardGradient1: 'from-zinc-900 via-amber-950 to-amber-900',
      cardGradient2: 'from-amber-600 to-amber-800',
      cardGradient3: 'from-amber-700 to-zinc-900',
      buttonClass: 'bg-white text-amber-700 hover:bg-amber-50',
      headerGradient: 'from-zinc-900 to-amber-700',
    },
    sidebarExtras: [
  ...
  other: {
    ...
    theme: {
      ...
      bgGradient: 'from-zinc-50 via-white to-rose-50/50',
      accent: 'rose',
      accentLight: 'rose-50',
      accentText: 'text-rose-700',
      cardGradient1: 'from-zinc-900 via-rose-950 to-rose-900',
      cardGradient2: 'from-rose-600 to-rose-800',
      cardGradient3: 'from-rose-700 to-zinc-900',
      buttonClass: 'bg-white text-rose-700 hover:bg-rose-50',
      headerGradient: 'from-zinc-900 to-rose-700',
    },
    sidebarExtras: [
