...
export const CATEGORY_CONTENT: Record<Category, CategoryContent> = {
  ...
  admission: {
    ...
    insights: [
      '멘토와 3회 이상 세션 진행 시 합격률이 90%로 상승',
      'AI 자소서 + 멘토 첨삭 병행 시 합격률 1.8배 증가',
      '골드 멘토의 멘티 합격률이 평균 대비 10%p 높음',
      '자소서 3회 이상 수정 시 합격률 12%p 상승',
    ],
  },
  career: {
    label: '취업',
    greeting: '취업 준비 어떻게 진행되고 있나요?',
    searchPlaceholder: '어떤 회사/직무를 준비하시나요?',
    aiToolTitle: 'AI 자기소개서 생성',
    aiToolDescription: '내 경험을 입력하면 AI가 합격 자소서 초안을 만들어드립니다',
    aiConsultingTitle: 'AI 맞춤 취업 컨설팅',
    aiConsultingDescription: '정형/비정형 정보를 분석하여 최적의 기업과 직무를 추천합니다',
    mentorLabel: '현직자 멘토',
    mentorDescription: 'AI가 분석한 나의 프로필에 최적화된 현직자 멘토를 추천합니다',
    field1Label: '지원 회사',
    ...
    insights: [
      '멘토와 3회 이상 세션 진행 시 취업률이 88%로 상승',
      'AI 자소서 + 멘토 첨삭 병행 시 서류 통과율 2.3배 증가',
      '골드 멘토의 멘티 취업률이 평균 대비 12%p 높음',
      '자소서 3회 이상 수정 시 서류 통과율 20%p 상승',
    ],
  },
  certification: {
    label: '자격증',
    greeting: '자격증/공모전 준비 어떻게 진행되고 있나요?',
    searchPlaceholder: '어떤 자격증/공모전을 준비하시나요?',
    aiToolTitle: 'AI 포트폴리오 생성',
    aiToolDescription: '내 경험을 입력하면 AI가 포트폴리오 초안을 만들어드립니다',
    aiConsultingTitle: 'AI 맞춤 자격증 컨설팅',
    aiConsultingDescription: '정형/비정형 정보를 분석하여 최적의 자격증과 전략을 추천합니다',
    mentorLabel: '합격자 멘토',
    mentorDescription: 'AI가 분석한 나의 프로필에 최적화된 합격자 멘토를 추천합니다',
    ...
    insights: [
      '멘토와 3회 이상 세션 진행 시 합격률이 85%로 상승',
      'AI 포트폴리오 + 멘토 피드백 병행 시 합격률 1.9배 증가',
      '골드 멘토의 멘티 합격률이 평균 대비 9%p 높음',
      '학습 계획 3회 이상 수정 시 합격률 13%p 상승',
    ],
  },
  other: {
    label: '기타',
    greeting: '목표 달성 어떻게 진행되고 있나요?',
    searchPlaceholder: '어떤 목표를 준비하시나요?',
    aiToolTitle: 'AI 문서 작성',
    aiToolDescription: '내 경험을 입력하면 AI가 맞춤 문서 초안을 만들어드립니다',
    aiConsultingTitle: 'AI 맞춤 컨설팅',
    aiConsultingDescription: '정형/비정형 정보를 분석하여 최적의 경로를 추천합니다',
    mentorLabel: '경험자 멘토',
    mentorDescription: 'AI가 분석한 나의 프로필에 최적화된 경험자 멘토를 추천합니다',
    field1Label: '목표',
    ...
    insights: [
      '멘토와 3회 이상 세션 진행 시 성공률이 85%로 상승',
      'AI 문서 + 멘토 피드백 병행 시 성공률 1.7배 증가',
      '골드 멘토의 멘티 성공률이 평균 대비 7%p 높음',
